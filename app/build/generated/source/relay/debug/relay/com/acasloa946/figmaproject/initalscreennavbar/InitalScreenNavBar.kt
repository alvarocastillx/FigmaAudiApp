package com.acasloa946.figmaproject.initalscreennavbar
...
/**
 * This composable was generated from the UI Package 'inital_screen_nav_bar'.
 * Generated code; do not edit directly
 */
@Composable
fun InitalScreenNavBar(
        ...
        FrameSettingsButton(
            ...
            SettingsIcon(
                ...
                modifier = Modifier.boxAlign(
                    alignment = Alignment.Center,
                    offset = DpOffset(
                        x = -2.3905105590820312.dp,
                        y = -0.5000247955322266.dp
                    )
                )
            ) {
                SettingsIconVector(
...
@Composable
private fun InitalScreenNavBarPreview() {
    MaterialTheme {
        RelayContainer {
            InitalScreenNavBar(
                onAudiIconClick = {},
...
fun Rectangle1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.inital_screen_nav_bar_rectangle_1),
...
fun AudiIconVector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.inital_screen_nav_bar_audi_icon_vector),
...
fun FrameAudiIcon(
    ...
    RelayContainer(
        ...
        isStructured = false,
        content = content,
        modifier = modifier.requiredWidth(136.0.dp).requiredHeight(60.0.dp)
    )
}
...
fun Vector1CarIcon(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.inital_screen_nav_bar_vector1car_icon),
...
fun SettingsIconVector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.inital_screen_nav_bar_settings_icon_vector),
