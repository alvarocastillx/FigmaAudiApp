package com.acasloa946.figmaproject.settingsnavigationbar
...
/**
 * This composable was generated from the UI Package 'settings_navigation_bar'.
...
@Composable
private fun SettingsNavigationBarPreview() {
    MaterialTheme {
        RelayContainer {
...
fun Rectangle1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.settings_navigation_bar_rectangle_1),
...
fun AudiIconVector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.settings_navigation_bar_audi_icon_vector),
...
fun Vector1CarIcon(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.settings_navigation_bar_vector1car_icon),
...
fun SettingsIconVector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.settings_navigation_bar_settings_icon_vector),
