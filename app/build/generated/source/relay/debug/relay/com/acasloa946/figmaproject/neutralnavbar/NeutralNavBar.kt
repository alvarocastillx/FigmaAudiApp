package com.acasloa946.figmaproject.neutralnavbar
...
/**
 * This composable was generated from the UI Package 'neutral_nav_bar'.
...
@Composable
private fun NeutralNavBarPreview() {
    MaterialTheme {
        RelayContainer {
            NeutralNavBar(
                onAudiIconClick = {},
...
fun Rectangle1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.neutral_nav_bar_rectangle_1),
...
fun AudiIconVector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.neutral_nav_bar_audi_icon_vector),
...
fun Vector1CarIcon(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.neutral_nav_bar_vector1car_icon),
...
fun SettingsIconVector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.neutral_nav_bar_settings_icon_vector),
