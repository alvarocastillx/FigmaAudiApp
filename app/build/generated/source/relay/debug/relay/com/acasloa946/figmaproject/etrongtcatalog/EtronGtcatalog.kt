package com.acasloa946.figmaproject.etrongtcatalog
...
/**
 * This composable was generated from the UI Package 'etron_gtcatalog'.
...
@Composable
private fun EtronGtcatalogPreview() {
    MaterialTheme {
        RelayContainer {
            EtronGtcatalog(
                onButtonSpecClick = {},
...
@Composable
fun TextEspecButtonEtron(modifier: Modifier = Modifier) {
    RelayText(
...
@Composable
fun Image25(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.etron_gtcatalog_image_25),
...
@Composable
fun TextoAudiEtron(modifier: Modifier = Modifier) {
    RelayText(
