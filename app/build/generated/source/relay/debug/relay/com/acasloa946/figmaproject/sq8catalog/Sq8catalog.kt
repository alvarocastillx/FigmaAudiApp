package com.acasloa946.figmaproject.sq8catalog
...
/**
 * This composable was generated from the UI Package 'sq8catalog'.
...
@Composable
fun TextEspecButtonSQ8(modifier: Modifier = Modifier) {
    RelayText(
...
fun ImageSQ8(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.sq8catalog_image_sq8),
...
@Composable
fun TextAudiSQ8(modifier: Modifier = Modifier) {
    RelayText(
