...
import com.acasloa946.figmaproject.bannersuperiorespecq4.BannerSuperiorEspecQ4
import com.acasloa946.figmaproject.bannersuperiorespecr8.BannerSuperiorEspecR8
import com.acasloa946.figmaproject.mainespecq4.MainEspecQ4
...
@Composable
fun EspecQ4Screen(navController: NavController) {
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            BannerSuperiorEspecQ4(modifier = Modifier.size(430.dp,78.dp))
            MainEspecQ4(modifier = Modifier.size(430.dp,1278.dp))
        }
        Box(
            modifier = Modifier
