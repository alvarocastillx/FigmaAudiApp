...
@Composable
fun EspecEtronScreen(navController: NavController) {
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            BannerSuperiorEspecEtron(modifier = Modifier.size(430.dp,78.dp))
            MainEspecEtron(modifier = Modifier.size(430.dp,1325.dp))
